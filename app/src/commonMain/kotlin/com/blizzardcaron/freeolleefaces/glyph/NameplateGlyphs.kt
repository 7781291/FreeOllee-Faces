...
object NameplateGlyphs {
    ...
    private val MASKS: Map<Char, Int> = mapOf(
        ...
        '>' to 0x4C, '?' to 0x5B, '@' to 0x7F, 'A' to 0x5F, 'B' to 0x7F, 'C' to 0x39,
        'D' to 0x3F, 'E' to 0x79, 'F' to 0x71, 'G' to 0x3D, 'H' to 0x76, 'I' to 0x30,
        'J' to 0x1E, 'K' to 0x7D, 'L' to 0x38, 'M' to 0x54, 'N' to 0x37, 'O' to 0x3F,
        'P' to 0x73, 'Q' to 0x6F, 'R' to 0x50, 'S' to 0x6D, 'T' to 0x78, 'U' to 0x3E,
        'V' to 0x3E, 'W' to 0x62, 'X' to 0x7E, 'Y' to 0x6F, 'Z' to 0x1B, '[' to 0x39,
        '\\' to 0x24, ']' to 0x0F, '^' to 0x23, '_' to 0x09, '`' to 0x02, 'a' to 0x5F,
        'b' to 0x7C, 'c' to 0x39, 'd' to 0x5E, 'e' to 0x7B, 'f' to 0x71, 'g' to 0x6F,
        'h' to 0x74, 'i' to 0x10, 'j' to 0x1E, 'k' to 0x7D, 'l' to 0x30, 'm' to 0x37,
        'n' to 0x54, 'o' to 0x3F, 'p' to 0x73, 'q' to 0x6F, 'r' to 0x50, 's' to 0x6D,
        't' to 0x78, 'u' to 0x62, 'v' to 0x1C, 'w' to 0x62, 'x' to 0x7E, 'y' to 0x6E,
        'z' to 0x1B, '{' to 0x00, '|' to 0x00, '}' to 0x16, '~' to 0x36,
    )
